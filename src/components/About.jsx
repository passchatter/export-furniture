    ...
    <>
     <div className="container pb-20 pt-14">
        <div className="grid md:grid-cols-4 grid-cols-3 lg:grid-cols-6 gap-5 mb-14 md:mb-32  justify-center items-center">
            <div className="bg-slate-100/35 mx-auto p-6 rounded-md shadow-md duration-300 hover:bg-primary">
                 <img className='w-[80px] text-center' src={produk1} alt="" />
            </div>
            <div className="bg-slate-100/35 mx-auto p-6 rounded-md shadow-md hover:bg-primary duration-300">
     ...
     <div className="pb-16 bg-[#484545]">
        <div className="md:flex grid grid-cols-1 items-center gap-7">
            ...
            <div className="max-w-lg mx-auto container py-10 md:py-0">
                <h1 className='text-white text-3xl mb-4'>"20 Years of Experience in Natural Rattan Products"</h1>
                <p className='text-slate-200 text-[.9rem]'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam alias a voluptas recusandae, eius animi provident reiciendis eligendi iste ea, quam nobis molestias cum corrupti repudiandae sapiente totam tempora optio?</p>
            </div>
        </div>
     </div>
